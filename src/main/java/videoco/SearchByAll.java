...
public class SearchByAll extends JFrame{
	...
	public SearchByAll() {
		...
		welcomeLabel = new JLabel("Search by All");
...
//			}
    	...
    	searchByTitleButton.addActionListener(new ActionListener() {
    		public void actionPerformed(java.awt.event.ActionEvent evt) 
    		{
    			...
    			String builder = searchByAllMethod(text);
    			...
    			for (Movie m : inventory.movie_database) {
    				if (m.getTitle().contains(text) || m.getCategories().contains(text) || String.valueOf(m.getID()).contains(text)|| text.equals("")) {
    					matches.add(m);
    					builder_ = builder_ + m.getTitle() + ", ";
...
//    	//Movie ID textbox
	...
	public String searchByAllMethod(String text) {
