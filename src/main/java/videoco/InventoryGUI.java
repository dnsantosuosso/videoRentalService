...
public class InventoryGUI extends JFrame{
	...
	public static JButton manageButton;
	...
	public InventoryGUI() {
		...
		welcomeLabel = new JLabel("Search by Title");
    	...
    	searchByTitleButton.addActionListener(new ActionListener() {
    		public void actionPerformed(java.awt.event.ActionEvent evt) 
    		{
    			...
    			for (Movie m : inventory.movie_database) {
    				if (m.getTitle().contains(text) || text.equals("")) {
    					matches.add(m);
...
//    	//Movie ID textbox
    	...
    	manageButton.setBounds(280,290,120,25);
    	manageButton.addActionListener(new ActionListener() {
    		public void actionPerformed(java.awt.event.ActionEvent evt) 
    		{
    			selected_title = movieTitle.getText();
    			new MovieGUI();
    		}
    	});
    	...
    	returnHomeButton.setBounds(115,320,165,25);
